...
ALTER TABLE THEDOCGIA ADD CONSTRAINT CK_LDG CHECK (LoaiDG IN('X', 'Y'))
ALTER TABLE THEDOCGIA ADD CONSTRAINT CK_T CHECK ((NgLapThe - NgSinhDG) BETWEEN 18 AND 55)

ALTER TABLE SACH ADD CONSTRAINT CK_TL CHECK (TheLoai IN('A', 'B', 'C'))
